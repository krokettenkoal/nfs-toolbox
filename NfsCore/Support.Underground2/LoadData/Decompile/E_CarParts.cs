...
namespace NfsCore.Support.Underground2
{
    public static partial class LoadData
    {
        ...
        private static unsafe void E_CarParts(byte* bytePtrT, uint length, Database.Underground2Db db)
        {
            uint offset = 0;
            ...
            while (offset < length)
            {
                ...
                if (offset + size > length) return; // in case of reading beyond the stream
