...
namespace NfsCore.Support.MostWanted.Class
{
    public partial class Texture : Shared.Class.Texture
    {
        ...
        public Texture(string collectionName, string parentTpk, Database.MostWantedDb db)
        {
            Database = db;
        ...
        public Texture(string collectionName, string parentTpk, string filename, Database.MostWantedDb db)
        {
            Database = db;
            CollName = collectionName;
            ParentTpkName = parentTpk;
        ...
        public unsafe Texture(byte* bytePtrT, int offset, int size, string parentTpk, Database.MostWantedDb db)
        {
            Database = db;
        ...
        // Default constructor: disassemble texture
        public unsafe Texture(byte* bytePtrT, uint offset, uint size, string parentTpk, Database.MostWantedDb db)
        {
            Database = db;
