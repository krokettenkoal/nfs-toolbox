...
namespace NfsCore.Support.Carbon
{
    public static partial class LoadData
    {
        ...
        private static unsafe void E_PresetSkins(byte* byteptr_t, uint length, Database.CarbonDb db)
        {
            uint size = 0x68;
            ...
            for (uint loop = 0; loop < length / size; ++loop)
            {
                ...
                // Get CollectionName
                var CName = ScriptX.NullTerminatedString(byteptr_t + offset + 0x8, 0x20);
